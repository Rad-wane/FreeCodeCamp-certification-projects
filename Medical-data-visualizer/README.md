...
I will use the dataset to exploring the relationship between cardiac disease, body measurements, blood markers, and lifestyle choices.
...
A chart similar to `examples/Figure_1.png`, where I show the counts of good and bad outcomes for cholesterol, gluc, alco variable, active, and smoke for patients with cardio=1 and cardio=0 in different panels.

I use the data to complete the following tasks in `medical_data_visualizer.py`:
